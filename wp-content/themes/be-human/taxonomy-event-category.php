<?php
/*
 * This file is used to generate WordPress standard event taxonomy pages.
 */
get_header ();
		...
		<?php breadcrumbs_html();?>
				<section id="blockContainer" class="row-fluid">
					...
					<div id="post-<?php the_ID(); ?>" class="<?php echo $sidebar_class[1];?>">
						...
						<h2 class="heading"><?php echo $wp_query->query['event-category'];?></h2>
						<span class="border-line m-bottom"></span>
					<?php if ( have_posts() ) : while ( have_posts() ) : the_post();
					global $post, $post_id;?>
							<?php
							//Image Dimenstion for different sidebars
