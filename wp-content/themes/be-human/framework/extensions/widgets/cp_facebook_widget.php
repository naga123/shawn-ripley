...
class facebook_widget extends WP_Widget
{
  function facebook_widget()
  {
    ...
    $this->WP_Widget('facebook_widget', 'CrunchPress : Facebook', $widget_ops);
  }
...
?>
  ...
  <label for="<?php echo $this->get_field_id('pageurl'); ?>">
	...
	<br />
      <small>Please enter your page url example: http://www.facebook.com/profilename OR <br />
  ...
  <label for="<?php echo $this->get_field_id('showfaces'); ?>">
	  ...
	  <select id="<?php echo $this->get_field_id('showfaces'); ?>" name="<?php echo $this->get_field_name('showfaces'); ?>" style="width:225px">
			<option <?php if($showfaces == 'true'){echo 'selected';}?> value="true">Yes</option>
			<option <?php if($showfaces == 'false'){echo 'selected';}?> value="false">No</option>
      </select>
  </label>
  </p>  
  <p>
  <label for="<?php echo $this->get_field_id('showstream'); ?>">
	  Show Stream: 
	   <select id="<?php echo $this->get_field_id('showstream'); ?>" name="<?php echo $this->get_field_name('showstream'); ?>" style="width:225px">
			<option <?php if($showstream == 'true'){echo 'selected';}?> value="true">Yes</option>
			<option <?php if($showstream == 'false'){echo 'selected';}?> value="false">No</option>
      </select>
  </label>
  </p> 
  <p>
