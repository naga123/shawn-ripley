...
Plugin URI: http://themeforest.net/user/CrunchPress
...
class twitter_widget extends WP_Widget
{
  ...
  {
    $widget_ops = array('classname' => 'twitter_widget', 'description' => 'Show Twitter Widget Tweets on your website' );
    $this->WP_Widget('twitter_widget', 'CrunchPress : Twitter Widget', $widget_ops);
  }
...
?>
  ...
  <label for="<?php echo $this->get_field_id('title'); ?>">
   ...
   <p>Please visit this link first <a href="https://dev.twitter.com/apps/new">https://dev.twitter.com/apps/new</a> 
	  it will take to page where you can make twitter app that will help you to get some details that you need to activate your twitter widget.
	</p>
  <p>
  ...
  <label for="<?php echo $this->get_field_id('username_widget'); ?>">
	  User Name (without twitter url for example: http://www.twitter.com/Envato write only Envato): 
  </label>
  <br/ >
			...
			while ($this_tweet = array_shift($tweets)) { ?>
				<li class="tweet-container">
					<!--<p class="tweet-user-names">
						<a href="https://twitter.com/intent/user?user_id=<?php echo $this_tweet->user->id_str; ?>"><?php echo $this_tweet->user->name; ?></a>
						<a href="https://twitter.com/intent/user?user_id=<?php echo $this_tweet->user->id_str; ?>">@<?php echo $this_tweet->user->screen_name; ?></a>
					</p>-->
					<?php echo linkify_tweet( $this_tweet->text, $this_tweet );?>
					<span><a href="http://twitter.com/<?php echo $this_tweet->user->screen_name; ?>/status/<?php echo $this_tweet->id_str; ?>"> <?php echo $this_tweet->user->screen_name; ?></a></span>
					<span> - <?php echo relativeTime( strtotime( $this_tweet->created_at)); ?></span>
				</li>
		<?php	
			}
		}
